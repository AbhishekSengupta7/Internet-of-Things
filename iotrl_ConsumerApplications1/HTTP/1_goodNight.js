...
const Coffee_Machine = "http://esiremotelab.esi.ei.tum.de:8080/Virtual-Coffee-Machine_1_1";
    ...
    try {
        servient.start().then(async (WoT) => {
            ...
            if (hour===21){
                ...
                var fs = require('fs');
                fs.writeFile(".\\HTTP Log files\\1_goodNight.result.json", c, function(err, result) {
