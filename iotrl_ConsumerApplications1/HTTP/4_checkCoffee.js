...
const Coffee_Machine = "http://esiremotelab.esi.ei.tum.de:8080/Virtual-Coffee-Machine_1_4";
    ...
    try {
        servient.start().then(async (WoT) => {
            ...
            if (bin_Status<=80 && water_Status>10 && coffee_Status>10) {
                ...
                fs.writeFile(".\\HTTP Log files\\4_checkCoffee.result.json", JSON.stringify(arr_final), function(err, result) {
