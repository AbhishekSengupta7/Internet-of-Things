...
const Coffee_Machine_1_3 = "http://esiremotelab.esi.ei.tum.de:8080/Virtual-Coffee-Machine_1_3";
    ...
    try {
        servient.start().then(async (WoT) => {
            ...
            if (current_state==="Ready"){
                ...
                fs.writeFile(".\\HTTP Log files\\3_checkEspresso1.result.json", JSON.stringify(arr1), function(err, result) {
